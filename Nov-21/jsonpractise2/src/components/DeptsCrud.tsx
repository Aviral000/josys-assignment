...
import { Dept, deptService } from "../services/deptService";
...
const DeptsCrud: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    {
      deptService.createDept(deptObj).then(() => 
        {
    ...
    {
      deptService.updateDept(deptObj).then(() => 
        {
  ...
  const handleUpdate = (deptno: number) => {
    ...
    deptService.getDeptById(deptno).then((response: Dept) => 
    {
  ...
  return (
    <>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              required
              readOnly={selectedDept ? true : false}
            />
          </div>
          <div>
            <label   className="block text-sm font-medium text-gray-700">
          ...
          <button
            ...
            className={`w-full ${
              ...
              selectedDept !== null ? "focus:ring-green-300" : "focus:ring-blue-300"
            }`}
          >
            {selectedDept !== null ? "Update Dept" : "Add Dept"}
          </button>

          {selectedDept !== null && <button
            type="submit"
      ...
      <section className="w-1/2 p-6">
        <h2 className="text-xl font-bold mb-6 text-gray-700">Department List</h2>
